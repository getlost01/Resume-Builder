    ...
    document.querySelector("#expSec").innerHTML +=`
            <div class="row" id="expSec${genId}">
                ...
                <div class="col-12 inputStyle col-md-6">
                    ...
                    <input   type="text" required placeholder="xyz firm" name="titleExp" >
                </div>
                <div class="col-12 inputStyle col-md-6">
                    <label for="designationExp"> Designation </label>
                    <input   type="text" required placeholder="SDE intern" name="designationExp" >
                </div>
                <div class="col-12 inputStyle col-md-6">
                    <label for="timeExp"> Time Span </label>
                    <input   type="text" required placeholder="22 june 2022 - present" name="timeExp" >
                </div>
                <div class="col-12 inputStyle col-md-6">
                    <label for="techExp"> Technology experience </label>
                    <input   type="text" required placeholder="nodeJS , reactjs , mongoose , JavaScript" name="techExp" >
                </div>
                <div class="col-12 inputStyle col-md-6">
                    <label for="descrpExp"> Description </label>
                    <input   type="text" required placeholder="My work is to improve efficiency of backend server and implement new features." name="descrpExp" >
                </div>
                <div class="col-12 inputStyle col-md-6">
                    <label for="linkExp"> Any link to share </label>
                    <input   type="url" placeholder="eg: https://My-Work-Is-This.com" name="linkExp" >
                </div>
             </div>
